...
@section('title', 'Report-Collection Forecasting')
@section('extraStyle')
...
@section('content')
  <section>
    <div class="section-header no-print">
      <ol class="breadcrumb">
        <li class="active">Collection Forecasting</li>
      </ol>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="well reportTitle" style="padding: 0;">
                        <div class="clearfix">
                          <div class="text-center text-bold text-default-dark">  Collection Forecasting </div>
                        </div>
                      </div>
                    </div>
                  </div>
