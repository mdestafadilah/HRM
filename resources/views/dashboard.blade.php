								...
								<div class="section-body">
									...
									<div class="row">
										...
										<div class="col-md-9">
											<div class="card">
												<div class="card-head">
													<header>Sales Collection history</header>
												</div><!--end .card-head -->
                ...
                var data = [
                    {
                        label: 'Collection',
                        data: [
                            [moment().subtract(168, 'hours').valueOf(), 5000000],
                            [moment().subtract(144, 'hours').valueOf(), 1000000],
                            [moment().subtract(108, 'hours').valueOf(), 2000000],
                            [moment().subtract(70, 'hours').valueOf(), 100000],
                            [moment().subtract(30, 'hours').valueOf(), 4520000],
                            [moment().subtract(12, 'hours').valueOf(), 800000],
                            [moment().valueOf(), 20]
                        ],
                        last: true
                    }
